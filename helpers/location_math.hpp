...
#ifndef _LOCATION_MATH_H
#define _LOCATION_MATH_H

extern bool loc_float_lesser_than(float current, float limit);
extern bool loc_float_greater_than(float current, float limit);
